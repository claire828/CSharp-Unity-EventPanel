...
/// 活動 - 七日任務頁面
/// </summary>
public class ComSevenDayImp : IDepositEventPage
{
    public DepositEventType DepositUIType { get { return DepositEventType.SevenDayLoginTask; } }
    ...
    public string BannerTittle { get { return PBSettingsV3.String[22029].Msg; } }
    /// <summary>
    /// 重置時間 - Server 
    /// </summary>
    ...
    #endregion
    public string ScrollItemTitle { get { return PBSettingsV3.String[22031].Msg; } }
